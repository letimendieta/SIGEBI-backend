...
public class Alergenos {
	...
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="seq_alergenos")
	@SequenceGenerator(name="seq_alergenos",sequenceName="seq_alergenos",allocationSize=1)
