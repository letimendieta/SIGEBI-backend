...
public class Preguntas {
	...
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="seq_preguntas")
	@SequenceGenerator(name="seq_preguntas",sequenceName="seq_preguntas",allocationSize=1)
