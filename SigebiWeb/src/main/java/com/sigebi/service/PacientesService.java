...
public interface PacientesService{
	...
	public Pacientes guardarPacienteHistorialClinico(ProcesoPacienteHistorialClinico paciente) throws Exception;
	
	public Pacientes actualizarPacienteHistorialClinico(ProcesoPacienteHistorialClinico paciente) throws Exception;
